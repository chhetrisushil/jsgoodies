...
(function(W, EU) {
    ...
    var utility = EU.utility,
        ObservableClass = EU.CreateClass({
            ...
            addObserver: function(observer) {
                utility.assert(observer instanceof EU.ObserverClass, 'Please provide instance of EU.ObserverClass');
    ...
    EU.ObservableClass = EU.ObservableClass || ObservableClass;
})(window, window.EU);
*/
